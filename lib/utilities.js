 ...
 * To be used with {{#crossLink "utilities/sendSignal:method"}}{{/crossLink}}
 *
 * To be used with {{#crossLink "Utilities"}}{{/crossLink}}
 *
 * This module also uses {{#crossLink "Foo"}}{{/crossLink}}, where Foo is a class name.
 * Also see {{#crossLink "utilities/Foo:method"}}{{/crossLink}},
 * where myClass is a class name and Foo is a method on that class.
 *
